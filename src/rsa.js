  ...
  if (window.XDomainRequest) {
    ...
    try {
      o.onreadystatechange = function () {
        if (o.readyState == 4) {
          if (
            (typeof ProxyCollector.internalPingTime === 'undefined' && new RegExp('internalPingTime').test(n)) ||
            (typeof ProxyCollector.externalPingTime === 'undefined' && new RegExp('externalPingTime').test(n))
          ) {
            n.call(this, r.duration());
          }
        }
...
function BlackberryLocationCollector() {
  ...
  this.generateGeolocationJSONStruct = function () {
    ...
    if (n !== null) {
      ...
      b = {
        GeoLocationInfo: [{ Status: r, Longitude: n.coords.longitude, Latitude: n.coords.latitude, Timestamp: a }],
      };
    } else {
...
//adding to window as we are lazy loading this in an Angular feature module, and the script does not run in the global scope
window['decode_deviceprint'] = decode_deviceprint;
window['encode_deviceprint'] = encode_deviceprint;
window['BrowserDetect'] = BrowserDetect;
window['IE_FingerPrint'] = IE_FingerPrint;
window['Mozilla_FingerPrint'] = Mozilla_FingerPrint;
window['Opera_FingerPrint'] = Opera_FingerPrint;
window['FingerPrint'] = FingerPrint;
window['ProxyCollector'] = ProxyCollector;
